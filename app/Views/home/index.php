                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Pelanggan</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $tt_pelanggan; ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $tr_sukses; ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $tr_hari_ini; ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <?php if ($pendapatan_hari_ini['total_pdp'] == null) : ?>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">0</div>
                            <?php else : ?>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pendapatan_hari_ini['total_pdp']; ?></div>
                            <?php endif; ?>
                        </div>
                        <div class="col-auto">
