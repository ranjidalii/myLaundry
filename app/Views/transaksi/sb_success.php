                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="/transaksi/edit/<?= $t['id_tr']; ?>" method="post" class="d-inline">
                                        ...
                                        <i>
                                            <button type="submit" class="text-info btn-outline-primary fa-solid fa-pen p-2 mb-1 rounded"></button>
                                        </i>
                                        <i>
                                            <button type="submit" class="text-info btn-outline-primary fa-solid fa-print p-2 rounded"></button>
                                        </i>
                                    </form>
                                </td>
                            </tr>
